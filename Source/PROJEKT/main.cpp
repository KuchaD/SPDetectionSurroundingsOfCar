...
template <long num_filters, typename SUBNET> using con5d = con<num_filters,8,8,2,2,SUBNET>;
template <long num_filters, typename SUBNET> using con5 = con <num_filters,8,8,1,1,SUBNET>;
